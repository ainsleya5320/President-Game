...
Six original fictional portraits now appear in adviser appointments, team cards, campaign briefings, and media encounters. Acting replacements retain their own initials until they receive distinct portraits; they do not inherit the former colleague's face. The portraits are embedded in the playable HTML. Generation prompts and source artwork are recorded in `Prototype/assets/characters/generation.json`.
